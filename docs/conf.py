#!/usr/bin/env python
#
# msm_we documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'sphinx.ext.napoleon',
              'sphinx.ext.todo', 'sphinx.ext.autosummary', 'nbsphinx']
...
version = msm_we.__version__
# The full version, including alpha/beta/rc tags.
release = msm_we.__version__
...
latex_documents = [
    (master_doc, 'msm_we.tex',
     'msm_we Documentation',
     'John Russo', 'manual'),
]
