    ...
    def do_stratified_clustering(self, arg):
        ...
        while not all_bins_have_segments:
            ...
            if used_iters > -1:
                ...
                log.debug(f"Had {[(seen_we_bins[i], len(_segs)) for i, _segs in enumerate(we_bin_segs)]}, need {min_coords}")
            ...
            log.debug(f"Segments {np.argwhere(segment_in_target)} were in target, and will be ignored")
